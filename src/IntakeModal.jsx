  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <h3>Smart Intake</h3>
        <div className="modal-svc">{service ? `// ${service}` : '// General Consult'}</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="notice">
            ...
            After submission, you will be redirected to our Discord Command Center.
            You must manually <strong style={{ display: 'inline', textTransform: 'none', letterSpacing: 0, color: '#fff' }}>"Create a Ticket"</strong> inside the server to be attended to by our team.
          </div>
